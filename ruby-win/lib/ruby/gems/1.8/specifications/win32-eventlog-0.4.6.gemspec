Gem::Specification.new do |s|
  ...
  s.files = ["lib/win32/eventlog.rb", "lib/win32/mc.rb", "test/CVS", "test/foo.mc", "test/tc_eventlog.rb", "test/tc_mc.rb", "test/ts_all.rb", "CHANGES", "CVS", "doc", "examples", "lib", "MANIFEST", "misc", "Rakefile", "README", "test", "win32-eventlog.gemspec", "doc/tutorial.txt"]
